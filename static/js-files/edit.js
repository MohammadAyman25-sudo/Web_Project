$(document).ready(
    function(){
        $("#level").val($("#level").attr("size"));
        $("#department").val($("#department").attr("size"));
        if($("#level").val() !== "Third Level"){
            $("#department").attr("disabled", true);
            $("#department").val("{{ student.dep }}");
        }
        else
            $("#department").attr("disabled", false);
        if($("#female").attr("class") === "True"){
            $("#female").attr("checked", true);
            $("#male").attr("checked", false);
            $("#male").attr("class", "False");
        }
        else if($("#male").attr("class") === "True"){
            $("#male").attr("checked", true);
            $("#female").attr("checked", false);
            $("#female").attr("class", "False");
        }
        if($("#active").attr("class") === "True"){
            $("#active").attr("checked", true);
            $("#inactive").attr("checked", false);
            $("#inactive").attr("class", "False");
        }
        else if($("#inactive").attr("class") === "True"){
            $("#inactive").attr("checked", true);
            $("#active").attr("checked", false);
            $("#active").attr("class", "False");
        }
        $("#level").change(
            function(){
                if($("#level").val() !== "Third Level"){
