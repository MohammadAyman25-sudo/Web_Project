    ...
    function(){
        ...
        function check_name(input_child, isvalidate, pattern) {
          if (input_child.value.length === 0 || pattern.test(input_child.value)) {
            isvalidate = false;
            Create_message(input_child);
          } else if (input_child.value.length > 255 || input_child.value.length < 6) {
            isvalidate = false;
            Create_message(input_child);
          }
          return isvalidate;
        ...
        function message(input_child) {
          ...
          if (input_child.id === "name") {
            if (input_child.value.length > 255 || input_child.value.length < 6) {
              return "The name must be at least 6 characters and atmost 255 characters";
            }
